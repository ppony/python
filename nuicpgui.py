...
class EncryptGUI(Frame):
    ...
    def __init__(self, master=None):
        ...
        EncryptGUI.prog = Programmer(self.interface)
        print("EncryptGUI __init__")
...
#        self.load["command"] =  self.loadMethod
        ...
        self.interface = OptionMenu(
            self.master, self.interface_opt, "usb_swd", "usb", "uart")
