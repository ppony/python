...
#ifndef __NUVOTON__
void *GetInfo1(unsigned int uPID,
              FLASH_PID_INFO_BASE_T *pInfo)
{
    ...
    static FLASH_PID_INFO_BASE_T g_FlashPIDs[] = {
        ...
        { 256 * 1024,   0 * 1024,  20 * 1024,    0x00020000,   4 * 1024,    0x00C56431}, //M0564VG4AE
        ...
        {   59 * 512,   0 * 1024,   4 * 1024,    0x00007600,   2 * 1024,    0x00B81040}, //NM1810ZC1AE
        ...
        { 512 * 1024,   0 * 1024, 160 * 1024,    0x0007FFFF,   4 * 1024,    0x00D48412}, //M484SIDAE2U
        { 256 * 1024,   0 * 1024,  96 * 1024,    0x0003FFFF,   4 * 1024,    0x00D48413}, //M484SGAAE2U
...
DLLEXPORT int sum1(unsigned int *gg, unsigned int ggg[2]){
...
DLLEXPORT bool GetInfo2(unsigned int uPID,
             ...
             unsigned int *puKPROM_Size)
{
    ...
    if (GetInfo1(uPID, &flashInfo) == NULL) {
        return false;
    }
